...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Execution.Result"] = $PS["Execution.Result"] || {};
  var exports = $PS["Execution.Result"];                   
  var Result = function (x) {
      return x;
  };
  var versions = function (v) {
      return v.versions;
  };
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Execution.Result.Step"] = $PS["Execution.Result.Step"] || {};
  var exports = $PS["Execution.Result.Step"];              
  var BashCommandExecution = (function () {
      function BashCommandExecution(value0) {
          this.value0 = value0;
      };
      BashCommandExecution.create = function (value0) {
          return new BashCommandExecution(value0);
      };
      return BashCommandExecution;
  })();
  var CommentCreation = (function () {
      function CommentCreation(value0) {
          this.value0 = value0;
      };
      CommentCreation.create = function (value0) {
          return new CommentCreation(value0);
      };
      return CommentCreation;
  })();
  var map = function (v) {
      return function (v1) {
          if (v1 instanceof BashCommandExecution) {
              return v.bashCommandExecution({
                  input: v1.value0.input,
                  output: v1.value0.output
              });
          };
          if (v1 instanceof CommentCreation) {
              return v.commentCreation(v1.value0);
          };
          throw new Error("Failed pattern match at Execution.Result.Step (line 109, column 49 - line 112, column 40): " + [ v1.constructor.name ]);
      };
  };
  var commentCreation = CommentCreation.create;
  var bashCommandExecution = BashCommandExecution.create;
  exports["bashCommandExecution"] = bashCommandExecution;
  exports["commentCreation"] = commentCreation;
  exports["map"] = map;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  ...
  exports["printParserError"] = printParserError;
  exports["fail"] = fail;
  exports["try"] = $$try;
...
(function($PS) {
  ...
  var make = Os;
  var encodeString = function (v) {
      return Data_String_NonEmpty_Internal.toString(v.name) + (" " + Data_String_NonEmpty_Internal.toString(v.release));
  };
  var decodeString = function (s) {
      var parser = Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_Combinators.many1(Text_Parsing_StringParser_CodePoints.noneOf(Data_Foldable.foldableArray)([ " ", "\x0a" ])))(function (releaseChars) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_CodePoints.skipSpaces)(function () {
              return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_Combinators.many1(Text_Parsing_StringParser_CodePoints.noneOf(Data_Foldable.foldableArray)([ "\x0a" ])))(function (nameChars) {
                  return Control_Applicative.pure(Text_Parsing_StringParser.applicativeParser)({
                      name: Data_String_NonEmpty_CodePoints.fromFoldable1(Data_List_Types.foldable1NonEmptyList)(Data_Functor.map(Data_List_Types.functorNonEmptyList)(Data_String_CodePoints.codePointFromChar)(nameChars)),
                      release: Data_String_NonEmpty_CodePoints.fromFoldable1(Data_List_Types.foldable1NonEmptyList)(Data_Functor.map(Data_List_Types.functorNonEmptyList)(Data_String_CodePoints.codePointFromChar)(releaseChars))
                  });
              });
          });
      });
      var v = Text_Parsing_StringParser.runParser(parser)(s);
      if (v instanceof Data_Either.Left) {
          return Data_Either.Left.create(Text_Parsing_StringParser.printParserError(v.value0));
      };
      if (v instanceof Data_Either.Right) {
          return Control_Applicative.pure(Data_Either.applicativeEither)(v.value0);
      };
      throw new Error("Failed pattern match at Os (line 77, column 3 - line 80, column 23): " + [ v.constructor.name ]);
  };
  var stringCodec = Data_Codec.basicCodec(decodeString)(encodeString);
  var serializableUnitStringOs = {
      serialize: function (v) {
          return Data_Codec.encode(stringCodec);
      }
  };
  exports["make"] = make;
  exports["serializableUnitStringOs"] = serializableUnitStringOs;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Example.Results.ReprintingCurrentTime"] = $PS["Example.Results.ReprintingCurrentTime"] || {};
  var exports = $PS["Example.Results.ReprintingCurrentTime"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_List = $PS["Data.List"];
  ...
  var Data_String_NonEmpty_Internal = $PS["Data.String.NonEmpty.Internal"];
  var Data_Tuple = $PS["Data.Tuple"];
  var Execution_Result = $PS["Execution.Result"];
  var Execution_Result_Step = $PS["Execution.Result.Step"];
  var Os = $PS["Os"];
  var Type_Proxy = $PS["Type.Proxy"];                
  var result = Execution_Result.make({
      os: Os.make({
          name: Data_String_NonEmpty_Internal.nes(Data_String_NonEmpty_Internal.nonEmptyNonEmpty({
              reflectSymbol: function () {
                  return "Linux";
              }
          }))(Type_Proxy["Proxy"].value),
          release: Data_String_NonEmpty_Internal.nes(Data_String_NonEmpty_Internal.nonEmptyNonEmpty({
              reflectSymbol: function () {
                  return "5.10.47-linuxkit";
              }
          }))(Type_Proxy["Proxy"].value)
      }),
      steps: Data_List.fromFoldable(Data_Foldable.foldableArray)([ Execution_Result_Step.commentCreation("Obtaining the current time"), Execution_Result_Step.bashCommandExecution({
          input: "date",
          output: "Sun Dec 19 13:40:19 UTC 2021\x0a"
      }), Execution_Result_Step.commentCreation("Printing it back"), Execution_Result_Step.bashCommandExecution({
          input: "echo 'the time was: Sun Dec 19 13:40:19 UTC 2021'",
          output: "the time was: Sun Dec 19 13:40:19 UTC 2021\x0a"
      }) ]),
      versions: Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("bash", "5.1.4(1)-release") ])
  });
...
(function($PS) {
  ...
  var serialize_ = function (dictSerializable) {
      return function (x) {
          return serialize(dictSerializable)(Data_Unit.unit)(x);
      };
  };
  var serializableUnitStringMap = function (dictSerializable) {
      return function (dictSerializable1) {
          return {
              serialize: function (v) {
                  return Data_FoldableWithIndex.foldMapWithIndex(Data_Map_Internal.foldableWithIndexMap)(Data_Monoid.monoidString)(function (k) {
                      return function (v1) {
                          return serialize_(dictSerializable)(k) + (": " + (serialize_(dictSerializable1)(v1) + "\x0a"));
                      };
                  });
              }
          };
  ...
  exports["serialize_"] = serialize_;
  exports["serializableUnitStringMap"] = serializableUnitStringMap;
  exports["serializableUnitStringStr"] = serializableUnitStringStr;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Example.Terminal"] = $PS["Example.Terminal"] || {};
  var exports = $PS["Example.Terminal"];
  var Data_Array = $PS["Data.Array"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_List_Types = $PS["Data.List.Types"];
  var Execution_Result = $PS["Execution.Result"];
  ...
  var render = function (result) {
      var renderStep = Execution_Result_Step.map({
          bashCommandExecution: function (v) {
              return [ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.classes([ "input" ]) ])([ Halogen_HTML_Core.text(v.input) ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.classes([ "output" ]) ])([ Halogen_HTML_Core.text(v.output) ]) ];
          },
          commentCreation: function (s) {
              return [ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.classes([ "comment" ]) ])([ Halogen_HTML_Core.text(s) ]) ];
          }
      });
      var renderWindow = function (steps) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "fakeMenu" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "fakeButtons", "fakeClose" ]) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "fakeButtons", "fakeMinimize" ]) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "fakeButtons", "fakeZoom" ]) ])([  ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "fakeScreen" ]) ])(Data_Array.concat(Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(renderStep)(steps)))) ]);
      };
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Demo") ]), Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("OS") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(Output.serialize_(Os.serializableUnitStringOs)(Execution_Result.os(result))) ]), Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Program versions") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(Output.serialize_(Output.serializableUnitStringMap(Output.serializableUnitStringStr)(Output.serializableUnitStringStr))(Execution_Result.versions(result))) ]), Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Output") ]), renderWindow(Execution_Result.steps(result)) ]));
          };
      });
  };
...
(function($PS) {
  ...
  var Data_Tuple = $PS["Data.Tuple"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Example_Results_ReprintingCurrentTime = $PS["Example.Results.ReprintingCurrentTime"];
  var Example_Terminal = $PS["Example.Terminal"];
  var Foreign_Object = $PS["Foreign.Object"];
  ...
  var examples = (function () {
      var index = Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Program demos") ]) ]));
          };
      });
      return Foreign_Object.fromFoldable(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("", index), new Data_Tuple.Tuple("ReprintingCurrentTime", Example_Terminal.render(Example_Results_ReprintingCurrentTime.result)) ]);
  })();
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_Storybook.runStorybook({
      stories: examples,
      logo: Data_Maybe.Just.create(Halogen_HTML_Core.text("Demo Examples"))
  })));
  exports["main"] = main;
